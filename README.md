...
> **Nota:** A funcionalidade do chat depende do workflow correspondente no **n8n.io** estar ativo e acessível pela URL configurada no arquivo `script.js`.
